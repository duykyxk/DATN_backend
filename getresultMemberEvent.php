  ...
  <table class="table table-hover" id="myTable">
    ...
    {foreach($faq as $k=>$v) { 
      ...
      <tr>
       ...
       elseif($faq[$k]['status']==5)  echo"Đã tham gia";
       elseif($faq[$k]['status']==9)  echo"Monitor chưa phê duyệt";
       elseif($faq[$k]['status']==10)  echo"Monitor đồng ý";
       elseif($faq[$k]['status']==11)  echo"Monitor từ chối";?></td>
